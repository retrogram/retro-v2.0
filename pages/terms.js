...
export default function Terms() {
    ...
    return (
        <div>
            <h2>RetroGram Terms and Conditions</h2>
            <p>Hello,

            Thank you for agreeing to share your story on RetroGram. RetroGram wishes to post your story on our web platform and share it to the world to see. Here are a few things to note: </p>
            <ul style={{ listStyle: 'none' }}>
                <li>- RetroGram is completely open-source and free for everyone to access. There are no paid services or
                hidden subscription or viewership fees.</li>

                <li>- RetroGram does not own rights to your content and as well will not be liable for how your content is used
                outside the RetroGram platform.</li>

                <li>- You own complete rights to your content and can at any time request by email for us to either edit,
                modify or delete it and other components (e.g comments) attached to your story.</li>
